...
public class BikeServerWebService {
	public static void main(String args[]) {
		try {
			...
			String url = "http://beta.racecontrol.co.za/UploadCSV.asmx";
	...
	private static SOAPMessage createSOAPRequest() throws Exception {
		...
		String serverURI = "http://admin.racecontrol.co.za/";

		// SOAP Envelope
		SOAPEnvelope envelope = soapPart.getEnvelope();
		envelope.addNamespaceDeclaration("TestMethod", serverURI);
...
//		soapBodyElem2.addTextNode("123");
		...
		headers.addHeader("SOAPAction", serverURI + "TestMethod");
//
